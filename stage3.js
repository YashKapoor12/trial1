...
function setup(){
	...
	platforms.push( ground=new Platform(width/2,height,width,40));
 	...
 	platforms.push(new Platform(300,200,100,15));
 	platforms.push(new Platform(450,240,100,15));
 	platforms.push(new Platform(600,190,100,15));
 	platforms.push(new Platform(750,230,100,15));
 	platforms.push(new Platform(900,120,100,15));
}
